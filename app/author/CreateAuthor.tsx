...
import Axios, { PostWithFile, PutWithFile } from "@/lib/axios";
...
export default function CreateAuthorForm() {
    ...
    const [authorData, setAuthorData] = useState<AuthorType>({
        ...
        proffession: author.proffession ? author.proffession : '',
        company_name: author.company_name ? author.company_name : '',
        image: author.image ? author.image : {},
    })
    const [imagePreview, setImagePreview] = useState<any>(author.image ? author.image : '')
    ...
    const handleSubmit = async (event: React.ChangeEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            const { data } = await PutWithFile('/author/edit', formData)
